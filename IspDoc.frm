...
Begin VB.Form SmevIspDoc 
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      Tab(6).Control(0)=   "CommandButtonValidate"
      Tab(6).Control(0).Enabled=   0   'False
      Tab(6).Control(1)=   "CommandButtonGenerate"
      Tab(6).Control(1).Enabled=   0   'False
      Tab(6).Control(2)=   "CommandButtonSign"
...
Dim docDir As String '= "E:\смэв\исполнительные_документы\"
Dim dd1 As String '= "E:\"
Dim dd2 As String '= "E:\смэв\"
...
'Set fso = CreateObject("Scripting.FileSystemObject")
'Set out = fso.CreateTextFile(StrFilename, True, True)
'out.WriteLine ("<?xml version='1.0'?>")
'out.WriteLine ("<config>")
'out.WriteLine ("<docDir>C:\смэв\исполнительные_документы\</docDir>")
'out.WriteLine ("<dd1>C:\</dd1>")
'out.WriteLine ("<dd2>C:\смэв\</dd2>")
'out.WriteLine ("</config>")
'out.Close
...
Private Sub initCheck()
    ...
    If Dir(dd1, vbDirectory) = "" Then
          MsgBox "Отсутствует " + dd1 + " - обратитесь в службу поддержки"
